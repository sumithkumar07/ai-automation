...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://feature-optimizer.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://feature-optimizer.preview.emergentagent.com")
