...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://workflow-analyzer-3.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://workflow-analyzer-3.preview.emergentagent.com")
