...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://ai-workflow-boost.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://ai-workflow-boost.preview.emergentagent.com")
