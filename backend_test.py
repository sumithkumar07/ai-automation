...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://app-health-monitor-1.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://app-health-monitor-1.preview.emergentagent.com")
