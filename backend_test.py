...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://interface-analysis.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://interface-analysis.preview.emergentagent.com")
