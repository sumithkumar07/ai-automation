...
class AetherAutomationAPITester:
    def __init__(self, base_url="https://parallel-testing.preview.emergentagent.com"):
...
def main():
    ...
    # Initialize tester
    tester = AetherAutomationAPITester("https://parallel-testing.preview.emergentagent.com")
